...
int main()
{
    ...
    std::string path = std::string(logl_root) + "/src/5.advanced_lighting/3.1.1.shadow_mapping_depth/";
    Shader simpleDepthShader(path + "3.1.1.shadow_mapping_depth.vs", path + "3.1.1.shadow_mapping_depth.fs");
    Shader debugDepthQuad(path + "3.1.1.debug_quad.vs", path + "3.1.1.debug_quad_depth.fs");
