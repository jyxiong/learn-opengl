...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // coordinate
        float radius = 10.0f;
        float camPosX = cos(glfwGetTime()) * radius;
        float camPosY = sin(glfwGetTime()) * radius;
        glm::mat4 view = glm::lookAt(glm::vec3(camPosX, 0.0f, camPosY), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
        ...
        for (unsigned int i = 0; i < 10; i++)
        {
            ...
            model = glm::rotate(model, (float)(i * 10), glm::vec3(1.0f, 2.0f, 3.0f));
